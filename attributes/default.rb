...
default['chef-apt-docker']['docker-stable']['keyserver'] = 'ha.pool.sks-keyservers.net'
...
default['chef-apt-docker']['docker-edge']['keyserver'] = 'ha.pool.sks-keyservers.net'
...
default['chef-apt-docker']['docker-test']['keyserver'] = 'ha.pool.sks-keyservers.net'
